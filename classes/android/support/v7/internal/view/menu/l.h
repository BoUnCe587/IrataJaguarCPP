			...
			namespace internal_Renamed
			{
				namespace view
				{
					namespace menu
					{
						...
						{
					  public:
						  static MenuItem *a(Context *paramContext, b *paramb);

						  static SubMenu *a(Context *paramContext, c *paramc);
						};


						/* Location:              C:\Users\Clayton\Desktop\IrataJag\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\internal\view\menu\l.class
