		...
		namespace altmer
		{
			namespace iratajaguar
			{
				...
				void MainActivity::f()
				{
				  ...
				  android.support::v4::a::a(2131099655, L"n0");
				  android.support::v4::a::a(2131099656, L"n1");
				  android.support::v4::a::a(2131099657, L"n2");
				  android.support::v4::a::a(2131099658, L"n3");
				  android.support::v4::a::a(2131099659, L"n4");
				  android.support::v4::a::a(2131099660, L"n5");
				  android.support::v4::a::a(2131099661, L"n6");
				  android.support::v4::a::a(2131099662, L"n7");
				  android.support::v4::a::a(2131099663, L"n8");
				  android.support::v4::a::a(2131099664, L"n9");
				  android.support::v4::a::a(2131099666, L"ns");
				  android.support::v4::a::a(2131099665, L"np");
				  android.support::v4::a::a(2131099648, L"a");
				  android.support::v4::a::a(2131099649, L"b");
				  android.support::v4::a::a(2131099650, L"c");
				  android.support::v4::a::a(2131099669, L"x");
				  android.support::v4::a::a(2131099667, L"p");
				}

				void MainActivity::g()
				{
				  setProgressBarIndeterminateVisibility(true);
				  this->j->a(this->i_Renamed);
				}
				...
				std::wstring MainActivity::android.support::v4::a::a(const std::wstring &paramString)
				{
				  try
				  {
					...
					if (file->exists() && file->isDirectory())
					{
					  ...
					  {
						if (StringHelper::toLower(arrayOfString[b1])->compareTo(L"jaguar") == 0)
						{
				...
				std::wstring com->google.android.vending.licensing.d()
				{
				  ...
				  if (this->h_Renamed->d(L"saves"))
				  {
					str1 = str2;
					if (!this->h_Renamed->f(L"saves")->isEmpty())
					{
					  str1 = this->h_Renamed->f(L"saves");
					}
				  }
				  return str1;
				}
				...
				void com->google.android.vending.licensing.e()
				{
				  ...
				  try
				  {
					if (this->h_Renamed->d(L"lockOri"))
					{
					  intent->putExtra(L"lockOrient", static_cast<Boolean>(this->h_Renamed->f(L"lockOri")));
					}
					if (this->h_Renamed->d(L"keepAspect"))
					{
					  NativeCore::setConfig(L"keepAspect", this->h_Renamed->f(L"keepAspect"));
					}
					if (this->h_Renamed->d(L"dspMT"))
					{
					  NativeCore::setConfig(L"dspMT", this->h_Renamed->f(L"dspMT"));
					}
					if (this->h_Renamed->d(L"gpuMT"))
					{
					  NativeCore::setConfig(L"gpuMT", this->h_Renamed->f(L"gpuMT"));
					}
				  }
				  catch (const std::exception &exception)
				  {
				  ...
				  if (this->g_Renamed != L"")
				  {
					NativeCore::setConfig(L"ext-bios", this->g_Renamed);
				  }
				...
				final void onActivityResult(int paramInt1, int paramInt2, android.content::Intent paramIntent)
				{
				  ...
				  if (paramInt1 == 1)
				  {
					...
					if (str != L"" && !str.isEmpty())
					{
					  ...
					  this->h_Renamed->a(L"dumps", str);
					  str = getResources().getString(2131165210) + L" " + str;
				  ...
				  if (paramInt1 == 2)
				  {
					...
					if (str != L"" && !str.isEmpty())
					{
					  this->h_Renamed->a(L"saves", str);
					  b(4);
					}
					NativeCore::setConfig(L"userStorage", com->google.android.vending.licensing.d());
					str = getResources().getString(2131165216) + L" " + com->google.android.vending.licensing.d();
				...
				void onCreate(android.os::Bundle paramBundle)
				{
				  ...
				  this->g_Renamed = intent->getStringExtra(L"bios");
				  if (this->f_Renamed != L"" || this->g_Renamed != L"")
				  {
					this->e = true;
				  ...
				  this->h_Renamed = new android.support::v4::a::a(getApplicationContext(), L"IrataJaguar-preferences", str2 + L"JustPlay", true);
				  if (!this->e)
				  {
					try
					{
					  if (this->h_Renamed->d(L"lockOri"))
					  {
						(static_cast<Switch*>(findViewById(2131558495)))->setChecked(static_cast<Boolean>(this->h_Renamed->f(L"lockOri")).booleanValue());
					  }
					  if (this->h_Renamed->d(L"keepAspect"))
					  {
						(static_cast<Switch*>(findViewById(2131558496)))->setChecked(static_cast<Boolean>(this->h_Renamed->f(L"keepAspect")).booleanValue());
					  }
					  if (this->h_Renamed->d(L"dspMT"))
					  {
						(static_cast<Switch*>(findViewById(2131558497)))->setChecked(static_cast<Boolean>(this->h_Renamed->f(L"dspMT")).booleanValue());
					  }
					  if (this->h_Renamed->d(L"gpuMT"))
					  {
						(static_cast<Switch*>(findViewById(2131558498)))->setChecked(static_cast<Boolean>(this->h_Renamed->f(L"gpuMT")).booleanValue());
					  }
					}
					...
					str1 = c();
					if (this->h_Renamed->d(L"dumps"))
					{
					  str1 = this->h_Renamed->f(L"dumps");
					}
					str = getResources().getString(2131165210) + L" " + str1;
					(static_cast<TextView*>(findViewById(2131558488)))->setText(str);
					int i2 = -1;
					int i1 = i2;
					try
					{
					  if (this->h_Renamed->d(L"selectedIndex"))
					  {
						i1 = static_cast<Integer>(this->h_Renamed->f(L"selectedIndex")).intValue();
					  }
					}
					...
					try
					{
					  if (this->h_Renamed->d(L"listSelection"))
					  {
						int i3 = static_cast<Integer>(this->h_Renamed->f(L"selectedIndex")).intValue();
						i2 = static_cast<Integer>(this->h_Renamed->f(L"listSelection")).intValue();
						i1 = i2;
						if (i3 > i2)
						{
						  i1 = i2 + 1;
				  ...
				  this->i_Renamed = new c(this, nullptr);
				  ...
				  this->j = new com->google.android.vending.licensing.d(this, &tempVar2, L"");
				  ...
				  if (!this->e)
				  {
					...
					{
					  android.widget::Toast::makeText(this, 2131165215, 0).show();
					}
					str1 = getResources().getString(2131165216) + L" " + com->google.android.vending.licensing.d();
					(static_cast<TextView*>(findViewById(2131558490)))->setText(str1);
					str1 = L"<b>" + getResources().getString(2131165204) + L"</b> " + L"1.0.7" + L" - " + getResources().getString(2131165203) + L" " + NativeCore::stringFromJNI() + L".";
				  ...
				  android.support::v4::a::a(2131099668, L"remove");
...
//JAVA TO C++ CONVERTER TODO TASK: The following line could not be converted:
				  ...
				  {
//JAVA TO C++ CONVERTER TODO TASK: The following line could not be converted:
					return (new android.app.AlertDialog.Builder(this)).setTitle(2131165212).setMessage(this.n).setNegativeButton(2131165213, new android.content.DialogInterface.OnClickListener(this)
					{
						  void onClick(android.content::DialogInterface param1DialogInterface, int param1Int)
						  {
							  this->a.finish();
				  ...
				  AlertDialog::Builder *builder = (&tempVar3)->setTitle(2131165220);
				  if (bool_Renamed)
				  {
					paramInt = 2131165219;
				  }
				  ...
				  if (bool_Renamed)
				  {
					...
					return builder->setPositiveButton(paramInt, &tempVar4)
					   ...
					   .setNegativeButton(2131165213, &tempVar5)
					   .create();
				  }
				  paramInt = 2131165206;
				  ...
				  return builder->setPositiveButton(paramInt, &tempVar6)
					 ...
					 .setNegativeButton(2131165213, &tempVar7)
					 .create();
				}
				...
				void onDefSaveDirSelect(android.view::View paramView)
				{
				  if (this->h_Renamed->d(L"saves"))
				  {
					this->m = this->h_Renamed->f(L"saves");
					if (!this->m.isEmpty())
					{
					  b(5);
					}
				  ...
				  NativeCore::setConfig(L"userStorage", com->google.android.vending.licensing.d());
				  std::wstring str = getResources().getString(2131165216) + L" " + com->google.android.vending.licensing.d();
				  (static_cast<TextView*>(findViewById(2131558490)))->setText(str);
				}
...
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
					this->h_Renamed->a(L"lockOri", Boolean::toString((static_cast<Switch*>(findViewById(2131558495)))->isChecked()));
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
					this->h_Renamed->a(L"keepAspect", Boolean::toString((static_cast<Switch*>(findViewById(2131558496)))->isChecked()));
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
					this->h_Renamed->a(L"dspMT", Boolean::toString((static_cast<Switch*>(findViewById(2131558497)))->isChecked()));
//JAVA TO C++ CONVERTER TODO TASK: There is no native C++ equivalent to 'toString':
					this->h_Renamed->a(L"gpuMT", Boolean::toString((static_cast<Switch*>(findViewById(2131558498)))->isChecked()));
				  }
				  this->j->a();
				  Activity::onDestroy();
				  c(L"onDestroy()");
			...
			public:
				...
				{ // Byte code:
				  ...
				  //   8: ldc_w ru/vastness/altmer/iratajaguar/EmulatorActivity
				  ...
				  //   47: astore_1
				  //   48: aload_0
				  //   49: getfield h : Lru/vastness/altmer/iratajaguar/a;
				  //   52: ldc_w 'dumps'
				  //   55: invokevirtual d : (Ljava/lang/String;)Z
				  //   58: ifeq -> 72
				  //   61: aload_0
				  //   62: getfield h : Lru/vastness/altmer/iratajaguar/a;
				  //   65: ldc_w 'dumps'
			  ...
			  public:
				  void android.support::v4::a::a(int param1Int)
				  {
					if (!this->a.isFinishing())
					{
					  ...
					  MainActivity::b(this->a).a(L"license", L"1.0.7");
					...
					if (!this->a.isFinishing())
					{
					  try
					  {
						if (MainActivity::b(this->a).d(L"license"))
						{
						  ...
						  {
							if (MainActivity::b(this->a).f(L"license")->compareTo(L"1.0.7") == 0)
							{
							  MainActivity::a(this->a, true);
							  if (MainActivity::g(this->a))
							  {
				  ...
				  { // Byte code:
					//   0: aload_0
					//   1: getfield a : Lru/vastness/altmer/iratajaguar/MainActivity;
					//   4: invokevirtual isFinishing : ()Z
					//   7: ifeq -> 11
					//   10: return
					//   11: aload_0
					//   12: getfield a : Lru/vastness/altmer/iratajaguar/MainActivity;
					//   15: invokestatic b : (Lru/vastness/altmer/iratajaguar/MainActivity;)Lru/vastness/altmer/iratajaguar/a;
					//   18: ldc 'license'
					//   20: invokevirtual d : (Ljava/lang/String;)Z
					//   23: ifeq -> 74
					//   26: aload_0
					//   27: getfield a : Lru/vastness/altmer/iratajaguar/MainActivity;
					//   30: invokestatic b : (Lru/vastness/altmer/iratajaguar/MainActivity;)Lru/vastness/altmer/iratajaguar/a;
					//   33: ldc 'license'
					...
					//   43: ifne -> 114
					//   46: aload_0
					//   47: getfield a : Lru/vastness/altmer/iratajaguar/MainActivity;
					//   50: iconst_1
					//   51: invokestatic a : (Lru/vastness/altmer/iratajaguar/MainActivity;Z)Z
					//   54: pop
					//   55: aload_0
					//   56: getfield a : Lru/vastness/altmer/iratajaguar/MainActivity;
					//   59: invokestatic g : (Lru/vastness/altmer/iratajaguar/MainActivity;)Z
					//   62: ifeq -> 10
					//   65: aload_0
					//   66: getfield a : Lru/vastness/altmer/iratajaguar/MainActivity;
					//   69: invokevirtual e : ()V
					//   72: return
					//   73: astore_2
					//   74: aload_0
					//   75: getfield a : Lru/vastness/altmer/iratajaguar/MainActivity;
					//   78: aload_0
					//   79: getfield a : Lru/vastness/altmer/iratajaguar/MainActivity;
					//   82: ldc 2131165205
					...
					//   101: invokestatic b : (Lru/vastness/altmer/iratajaguar/MainActivity;Ljava/lang/String;)Ljava/lang/String;
					//   104: pop
					//   105: aload_0
					//   106: getfield a : Lru/vastness/altmer/iratajaguar/MainActivity;
					//   109: iconst_2
					//   110: invokestatic a : (Lru/vastness/altmer/iratajaguar/MainActivity;I)V
					//   113: return
					//   114: aload_0
					//   115: getfield a : Lru/vastness/altmer/iratajaguar/MainActivity;
					//   118: invokestatic b : (Lru/vastness/altmer/iratajaguar/MainActivity;)Lru/vastness/altmer/iratajaguar/a;
					//   121: ldc 'license'
